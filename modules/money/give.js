    ...
    if (Bastion.credentials.ownerId.includes(message.author.id)) {
      ...
      message.channel.send({
        embed: {
          ...
          description: `You've awarded **${args.amount}** LastMagic Currencies to <@${user.id}>.`
        }
      }).catch(e => {
        Bastion.log.error(e);
      });
      ...
      user.send({
        embed: {
          color: Bastion.colors.GREEN,
          description: `Your account has been debited with **${args.amount}** LastMagic Currencies.`
        }
      }).catch(e => {
        Bastion.log.error(e);
      });
      ...
      message.channel.send({
        embed: {
          color: Bastion.colors.GREEN,
          description: `You have given **${args.amount}** LastMagic Currencies to <@${user.id}>.`
        }
      }).catch(e => {
        Bastion.log.error(e);
      });
      ...
      message.author.send({
        embed: {
          ...
          description: `Your account has been credited with **${args.amount}** LastMagic Currencies.`
        }
      }).catch(e => {
        Bastion.log.error(e);
      });
